...
<a href = " {{ route('posts.outgo_create') }}" class="btn btn-info text-white ml-10">新規登録</a>
  ...
  <tbody>
   ...
   <tr class="primary">
    <th class="table-primary">支出</th> 
    <td class="col-xs-1 col-ma-1 col-lg-1 table-primary">{{ $outgo->amount }}</td>
   </tr>
 
   <tr>
    <th>収支</th>
    <td class="col-xs-1 col-ma-1 col-lg-1">{{$income->amount}}-{{$outgo->amount}}</td>
   </tr>
   </tbody>
  @endforeach
@endforeach
