...
<a href = " {{ route('posts.outgo_create') }}" class="btn btn-info text-white ml-10">新規登録</a>
  ...
  <tbody>
   ...
   <tr class="primary">
    ...
    <td class="col-xs-1 col-ma-1 col-lg-1 table-primary"><?php $month_sum = $income->amount- $expense->amount;
    $abs_month_sum=abs(month_sum); ?><?php echo number_format($abs_month_sum);?></td>
   </tr>
   </tbody>
</table>
</div>
