...
Route::post('/posts/outgo_create',[OutgoController::class,'outgo_store'])->name('posts.outgo_store');
Route::put('/posts/{outgo}',[OutgoController::class,'update'])->name('posts.update');
Route::delete('/posts/{outgo}',[OutgoController::class,'destroy'])->name('posts.destroy');

Route::get('/posts/income_create',[IncomeController::class,'income_create'])->name('posts.income_create');
Route::post('/posts/income_create',[IncomeController::class,'income_create'])->name('posts.income_create');
Route::post('/posts/income_create',[IncomeController::class,'income_store'])->name('posts.income_store');
Route::delete('/posts/{income}',[IncomeController::class,'destroy'])->name('posts.destroy');
