...
Route::get('/',[IncomController::class,'index']);
...
Route::get('ajax/outgos',[App\Http\Controllers\Ajax\IncomeController::class,'show']);
Route::get('ajax/posts/months',[App\Http\Controllers\Ajax\IncomeController::class,'months']);
Route::get('ajax/posts/years',[App\Http\Controllers\Ajax\IncomeController::class,'years']);
